...
function pintaDuvidas(){
  ...
  if (!lista.length){
    L.innerHTML = `<p class="empty">Nenhuma dúvida guardada.<br><br>
      Quando uma busca não encontrar resposta no conteúdo,
      você pode guardá-la aqui — vira a lista do que ainda falta escrever.</p>`;
    return;
  }
