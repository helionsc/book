...
const casos = [
  ...
  // Quando a pergunta nomeia a suspeita, a ferramenta especifica vence o diferencial
  ["paciente septico com hipotensao", "qsofa", {}],
  // Sem suspeita nomeada, o diferencial e a resposta certa
  ["paciente com dispneia no transporte", "dif-dispneia", {}],
  ["pressao caiu durante a remocao", "dif-hipotensao", {}],
  ["falta de ar", "dif-dispneia", {}],
  // contexto pediatrico decide a ferramenta, nao o nome da droga
  ["dose de adrenalina pediatrica", "pcr-pediatrica", {}],
  ["midazolam em lactente", "pcr-pediatrica", {}],
  ["parada em crianca", "pcr-pediatrica", {}],
  ["fentanil em crianca de 12 kg", "pcr-pediatrica", {}],
  // sem marcador pediatrico, as ferramentas de adulto seguem vencendo
  ["quanto de noradrenalina em paciente de 70kg", "bic", { peso: 70 }],
  ["etomidato 70 kg", "iot-rapida", { peso: 70 }],
